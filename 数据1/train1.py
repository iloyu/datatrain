...
#+ lamb*tf.reduce_mean(tf.square(d_pre_update - d_real))#lamb*tf.reduce_mean(tf.square(outputs - inputs_realdata)) #+ gama*tf.reduce_mean(tf.square(absoluteError))
...
writer = SummaryWriter('./log3',sess.graph)
