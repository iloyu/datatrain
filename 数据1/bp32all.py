...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 16 10:17:35 2018
...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  9 19:19:51 2018
...
loss_summary = scalar_summary('lossall',loss)
...
with tf.Session(config = config) as sess:
    ...
    sess.run(init)
    writer = SummaryWriter('./log5',sess.graph)
#    costTrain_history=[ ]
#    costTest_history=[ ]
    MinMean=1000000000
    ...
    for j in range(col1):
        ...
        np.savetxt('Realthicknessall.csv', thickMatrixReal, delimiter = ',')
...
#             print('predictionTest:\n',predictest)
             ...
             if i%2000 ==0:
               np.savetxt('dismeanall.csv', Savedismean, delimiter = ',')
               np.savetxt('disstdall.csv', Savestd, delimiter = ',')
               np.savetxt('originalall.csv', Savepre, delimiter = ',')
               np.savetxt('thicknessall.csv', SaveMatrixpre, delimiter = ',')
